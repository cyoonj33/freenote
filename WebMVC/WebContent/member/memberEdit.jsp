...
<div class="container">
   <h1 style="padding:30px; text-align:cneter;">회원정보 수정</h1>
   ...
   <ul id="regForm">
      ...
      <li>    <!-- 등산/ 자전거/ -->
        ...
        <input type="checkbox" name="interest" value="쇼핑" <c:forEach var="i" items="${vo.interest}"><c:if test="${i=='쇼핑'}">checked</c:if></c:forEach>>쇼핑
        ...
        <input type="checkbox" name="interest" value="영화"<c:forEach var="i" items="${vo.interest}"><c:if test="${i=='영화'}">checked</c:if></c:forEach>/>영화
        ...
        <input type="checkbox" name="interest" value="숨쉬기"<c:forEach var="i" items="${vo.interest}"><c:if test="${i=='숨쉬기'}">checked</c:if></c:forEach>/>숨쉬기             
      </li>
